...
export async function POST(req: Request) {
  ...
  // ALWAYS ON — including during checkout field collection. A slur must never be
  // accepted as an order detail: typing "Kariya" as the delivery name is caught
  // and redirected, not saved as the recipient. (This deliberately reverses the
  // earlier mid-checkout bypass — blocking slurs everywhere is the priority.)
  {
